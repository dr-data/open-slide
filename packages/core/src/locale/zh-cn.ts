...
export const zhCN: Locale = {
  ...
  slide: {
    ...
    exportToGoogleSlides: '导出到 Google 幻灯片…',
    googleSlidesExportFailed: '无法导出到 Google 幻灯片。',
    googleImportTitle: '从 Google 幻灯片导入',
    googleImportDescription: '将 Google 演示文稿导入为可编辑 TSX（不经过 PPTX）。',
    googleImportAction: '导入',
    googleImportSuccess: '已从 Google 幻灯片导入。',
    googleImportFailed: '无法从 Google 幻灯片导入。',
    googleSyncTitle: '从 Google 幻灯片同步',
    googleSyncDescription: '当关联的 Google 演示文稿有更新时，替换当前幻灯片。',
    googleSyncAction: '立即同步',
    googleSyncSuccess: '已从 Google 幻灯片同步。',
    googleSyncFailed: '无法从 Google 幻灯片同步。',
    googleSyncUpToDate: '已与 Google 幻灯片保持同步。',
    googlePresentationUrlLabel: 'Google 幻灯片链接',
    googleNewSlideIdLabel: '新幻灯片 id（相同则替换当前）',
    googleOpenPresentation: '在 Google 幻灯片中打开',
    googleDisconnect: '断开 Google 连接',
    googleClientIdMissing: '请在 open-slide.config.ts 中设置 googleClientId。',
    gwsAuthHint: '使用 gws CLI 凭证。在终端运行：gws auth login -s slides,drive',
    gwsAuthConnectedPrefix: '已通过 gws 连接',
    gwsAuthConnectedFallback: 'Google 账号',
    googleSyncNotLinked: '请先导出到 Google 幻灯片以关联此演示文稿。',
    importFromGoogleSlides: '从 Google 幻灯片导入…',
    syncFromGoogleSlides: '从 Google 幻灯片同步…',
    present: '演示',
  ...
  inspector: {
    ...
    heightLabel: '高度',
    marginTopLabel: '外边距上',
    marginRightLabel: '外边距右',
    marginBottomLabel: '外边距下',
    marginLeftLabel: '外边距左',
    paddingTopLabel: '内边距上',
    paddingRightLabel: '内边距右',
    paddingBottomLabel: '内边距下',
    paddingLeftLabel: '内边距左',
    textColor: '文字',
    backgroundColor: '背景',
    imageSection: '图片',
