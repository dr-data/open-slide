...
export type Locale = {
  ...
  slide: {
    ...
    exportToGoogleSlides: string;
    googleSlidesExportFailed: string;
    googleImportTitle: string;
    googleImportDescription: string;
    googleImportAction: string;
    googleImportSuccess: string;
    googleImportFailed: string;
    googleSyncTitle: string;
    googleSyncDescription: string;
    googleSyncAction: string;
    googleSyncSuccess: string;
    googleSyncFailed: string;
    googleSyncUpToDate: string;
    googlePresentationUrlLabel: string;
    googleNewSlideIdLabel: string;
