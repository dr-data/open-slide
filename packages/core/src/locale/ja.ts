...
export const ja: Locale = {
  ...
  slide: {
    ...
    exportToGoogleSlides: 'Google スライドに書き出し…',
    googleSlidesExportFailed: 'Google スライドへの書き出しに失敗しました。',
    googleImportTitle: 'Google スライドからインポート',
    googleImportDescription:
      'Google プレゼンテーションを編集可能な TSX として取り込みます（PPTX 経由ではありません）。',
    googleImportAction: 'インポート',
    googleImportSuccess: 'Google スライドからインポートしました。',
    googleImportFailed: 'Google スライドからのインポートに失敗しました。',
    googleSyncTitle: 'Google スライドから同期',
    googleSyncDescription: 'リンクした Google プレゼンテーションの変更をこのデッキに反映します。',
    googleSyncAction: '今すぐ同期',
    googleSyncSuccess: 'Google スライドから同期しました。',
    googleSyncFailed: 'Google スライドからの同期に失敗しました。',
    googleSyncUpToDate: 'Google スライドと同期済みです。',
    googlePresentationUrlLabel: 'Google スライド URL',
    googleNewSlideIdLabel: '新しいスライド id（同じ id で置き換え）',
    googleOpenPresentation: 'Google スライドで開く',
    googleDisconnect: 'Google 連携を解除',
    googleClientIdMissing: 'open-slide.config.ts に googleClientId を設定してください。',
    gwsAuthHint: 'gws CLI の認証を使用します。ターミナルで: gws auth login -s slides,drive',
    gwsAuthConnectedPrefix: 'gws で接続済み',
    gwsAuthConnectedFallback: 'Google アカウント',
    googleSyncNotLinked: '先に Google スライドへ書き出してリンクしてください。',
    importFromGoogleSlides: 'Google スライドからインポート…',
    syncFromGoogleSlides: 'Google スライドから同期…',
    present: '発表',
  ...
  inspector: {
    ...
    widthLabel: '幅',
    heightLabel: '高さ',
    marginTopLabel: 'マージン上',
    marginRightLabel: 'マージン右',
    marginBottomLabel: 'マージン下',
    marginLeftLabel: 'マージン左',
    paddingTopLabel: 'パディング上',
    paddingRightLabel: 'パディング右',
    paddingBottomLabel: 'パディング下',
    paddingLeftLabel: 'パディング左',
    textColor: 'テキスト',
    backgroundColor: '背景',
    imageSection: '画像',
