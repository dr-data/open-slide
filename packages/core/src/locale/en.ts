...
export const en: Locale = {
  ...
  slide: {
    ...
    exportToGoogleSlides: 'Export to Google Slides…',
    googleSlidesExportFailed: "Couldn't export to Google Slides.",
    googleImportTitle: 'Import from Google Slides',
    googleImportDescription:
      'Pull a Google presentation into open-slide as editable TSX (not via PPTX).',
    googleImportAction: 'Import',
    googleImportSuccess: 'Imported from Google Slides.',
    googleImportFailed: "Couldn't import from Google Slides.",
    googleSyncTitle: 'Sync from Google Slides',
    googleSyncDescription: 'Replace this deck with the linked Google presentation when it changes.',
    googleSyncAction: 'Sync now',
    googleSyncSuccess: 'Synced from Google Slides.',
    googleSyncFailed: "Couldn't sync from Google Slides.",
    googleSyncUpToDate: 'Already up to date with Google Slides.',
    googlePresentationUrlLabel: 'Google Slides URL',
    googleNewSlideIdLabel: 'New slide id (or same id to replace)',
    googleOpenPresentation: 'Open in Google Slides',
    googleDisconnect: 'Disconnect Google',
    googleClientIdMissing: 'Set googleClientId in open-slide.config.ts to connect Google Slides.',
    gwsAuthHint: 'Uses gws CLI credentials. In your terminal run: gws auth login -s slides,drive',
    gwsAuthConnectedPrefix: 'Connected via gws as',
    gwsAuthConnectedFallback: 'Google account',
    googleSyncNotLinked: 'Export to Google Slides first to link this deck.',
    importFromGoogleSlides: 'Import from Google Slides…',
    syncFromGoogleSlides: 'Sync from Google Slides…',
    present: 'Present',
  ...
  inspector: {
    ...
    marginLeftLabel: 'Margin left',
    paddingTopLabel: 'Padding top',
    paddingRightLabel: 'Padding right',
    paddingBottomLabel: 'Padding bottom',
    paddingLeftLabel: 'Padding left',
    textColor: 'Text',
